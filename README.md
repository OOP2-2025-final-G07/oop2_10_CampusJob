...
*  職種と主な仕事内容の例を一覧表で表示  
 ...
 　　
* ![](appeal_point_images/appeal_point_2.png)
  

*  時給グラフの視認性向上の工夫  
最も人数の多い時給帯の目盛りを赤色で強調表示し、分布の特徴が一目で分かるようにした。　　
　　
![](appeal_point_images/appeal_point_3.png)
  

* 学年ごとの色分けによる比較分析  
学年ごとに色分けを行うことで、時給と学年の関係を視覚的に比較・分析しやすくした。　　
　　
![](appeal_point_images/appeal_point_4.png)
  

*  未入力項目のチェックによる入力漏れ防止   
未入力の項目がある場合はデータを追加できないように制御し、登録時の入力漏れを防止している。　　
　　
![](appeal_point_images/appeal_point_5.png)
  

* 時給入力値のバリデーションを実装  
時給に負の数を入力できないよう制御し、下限を岐阜県の最低賃金である1065円に設定した。上限については法律上の規定がないため、制限を設けていない。　　
　　
![](appeal_point_images/appeal_point_6.png)
  

* 削除機能における安全設計   
既に使用されているアルバイト先は削除できないように制御し、データ不整合などのエラーを事前に防止している。　　
　　
![](appeal_point_images/appeal_point_7-1.png)
![](appeal_point_images/appeal_point_7-2.png)
...
　　
![](appeal_point_images/appeal_point_8.png)
